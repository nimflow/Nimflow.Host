...
{
    /// <summary>
    ///     Credits to https://stackoverflow.com/questions/210650/validate-image-from-file-in-c-sharp Xzar response
    /// </summary>
    public class ImageValidator
    {
        private readonly Dictionary<string, byte[]> _validBytes = new()
        {
            { ".bmp", new byte[] { 66, 77 } },
        ...
        /// </summary>
        private readonly Dictionary<Guid, string> _validGuids = new()
        {
